        ...
        <article class="who-to-follow">
            ...
            try{
                $query = $db->prepare('SELECT iUserId, sName, sUsername, sUserImage FROM users WHERE iUserId NOT IN (SELECT iFolloweeFk FROM followers WHERE iFollowerFk = :sessionId) AND iUserId != :sessionId');
